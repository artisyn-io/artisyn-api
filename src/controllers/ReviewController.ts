...
export default class extends BaseController {
    ...
    create = async (req: Request, res: Response) => {
        ...
        const duplicateWhere: { authorId: string; targetId: string; artisanId?: string | null } = {
            authorId,
        ...
        RequestError.abortIf(
            !!existingReview,
            "You have already reviewed this curator" + (data.artisan_id ? " for this artisan" : ""),
            422
        );
    ...
    update = async (req: Request, res: Response) => {
        ...
        const review = await prisma.review.update({
            ...
            data: {
                ...
                comment: data.comment !== undefined ? data.comment : existingReview!.comment,
            },
            include: {
                author: {
                    select: {
    ...
    report = async (req: Request, res: Response) => {
        ...
        const data = await this.validateAsync(req, {
            reason: "required|string|in:SPAM,INAPPROPRIATE,FAKE,HARASSMENT,OFF_TOPIC,OTHER",
    ...
    curatorReviews = async (req: Request, res: Response) => {
        ...
        RequestError.abortIf(curator!.role !== "CURATOR", "User is not a curator", 422);
