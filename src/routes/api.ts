...
router.get(
  "/preferences",
  authenticateToken,
  new PreferencesController().getPreferences
);
router.post(
  "/preferences",
  authenticateToken,
  new PreferencesController().updatePreferences
);
router.post(
  "/preferences/notifications",
  authenticateToken,
  new PreferencesController().updateNotifications
);
router.post(
  "/preferences/two-factor/toggle",
  authenticateToken,
  new PreferencesController().toggleTwoFactor
);
router.post(
  "/preferences/reset",
  authenticateToken,
  new PreferencesController().resetPreferences
);
...
router.get(
  "/privacy",
  authenticateToken,
  new PrivacySettingsController().getPrivacySettings
);
router.post(
  "/privacy",
  authenticateToken,
  new PrivacySettingsController().updatePrivacySettings
);
router.post(
  "/privacy/visibility",
  authenticateToken,
  new PrivacySettingsController().updateProfileVisibility
);
router.post(
  "/privacy/block",
  authenticateToken,
  new PrivacySettingsController().blockUser
);
router.post(
  "/privacy/unblock",
  authenticateToken,
  new PrivacySettingsController().unblockUser
);
router.get(
  "/privacy/blocklist",
  authenticateToken,
  new PrivacySettingsController().getBlockList
);
router.post(
  "/privacy/retention",
  authenticateToken,
  new PrivacySettingsController().updateDataRetention
);
...
router.get(
  "/account-links",
  authenticateToken,
  new AccountLinkingController().getLinkedAccounts
);
router.post(
  "/account-links",
  authenticateToken,
  new AccountLinkingController().linkAccount
);
router.get(
  "/account-links/:provider",
  authenticateToken,
  new AccountLinkingController().checkProviderLinked
);
router.delete(
  "/account-links/:provider",
  authenticateToken,
  new AccountLinkingController().unlinkAccount
);
...
router.post(
  "/data-export/request",
  authenticateToken,
  new DataExportController().requestDataExport
);
router.get(
  "/data-export/requests",
  authenticateToken,
  new DataExportController().getExportRequests
);
router.get(
  "/data-export/:requestId/status",
  authenticateToken,
  new DataExportController().getExportStatus
);
router.get(
  "/data-export/:requestId/download",
  authenticateToken,
  new DataExportController().downloadExport
);
router.post(
  "/data-export/:requestId/cancel",
  authenticateToken,
  new DataExportController().cancelExport
);
router.post(
  "/account/deletion-request",
  authenticateToken,
  new DataExportController().requestAccountDeletion
);
router.post(
  "/account/cancel-deletion",
  authenticateToken,
  new DataExportController().cancelAccountDeletion
);

// Finder routes (for USER role - Finders)
router.use("/finder", (await import("./api/finder")).default);
